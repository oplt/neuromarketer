...
Intel system is disabled. To activate:
  ...
  node /home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs
