...
<required_reading>
@/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/references/verification-patterns.md
@/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/templates/verification-report.md
</required_reading>
...
```bash
node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap analyze
```
...
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" frontmatter get "$plan" --field must_haves)
...
```bash
PHASE_DATA=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${phase_number}" --raw)
```
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" verify artifacts "$plan")
...
```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" verify key-links "$plan")
...
See /home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/templates/verification-report.md for complete template.
</step>
