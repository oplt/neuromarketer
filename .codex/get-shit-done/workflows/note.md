...
- **Global scope**: `/home/polat/Desktop/Projects/content_generator/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/polat/Desktop/Projects/content_generator/.codex/notes/`)
...
2. Glob `/home/polat/Desktop/Projects/content_generator/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/polat/Desktop/Projects/content_generator/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/polat/Desktop/Projects/content_generator/.codex/notes/` — works in any directory
