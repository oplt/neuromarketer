...
```bash
INIT=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" init todos)
...
```bash
slug=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" generate-slug "$title" --raw)
```
...
```bash
node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture todo - [title]" --files .planning/todos/pending/[filename] .planning/STATE.md
```
