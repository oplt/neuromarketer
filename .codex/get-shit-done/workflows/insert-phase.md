...
```bash
INIT=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/home/polat/Desktop/Projects/content_generator/.codex/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
